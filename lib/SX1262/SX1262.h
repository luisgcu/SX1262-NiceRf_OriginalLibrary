...
// Remove conflicting type definitions - use standard types
// typedef		boolean			bool;       // Already defined
// typedef 	unsigned char	uint8_t;   // Already defined
// typedef 	unsigned int	uint16_t;  // Already defined  
// typedef 	unsigned long	uint32_t;  // Already defined
...
public:
	// Constructor.
	SX1262(uint8_t NSS_Pin = 10, uint8_t NRESET_Pin = 9,uint8_t BUSY_Pin = 8,uint8_t DIO1_Pin = 7);
